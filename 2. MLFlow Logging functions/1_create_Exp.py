...
if __name__ =="__main__":
    ...
    # Experiment
    # create experiment will return exp_id

    # For storing the artifacts at some other location
    artifacts_loc = Path.cwd().joinpath("my_artifacts").as_uri()

    # exp_id = mlflow.create_experiment(name="Exp_create01",
    #                                   tags={"version" : "v1", "priority" : "p1"},
    #                                   )

    exp_id = mlflow.create_experiment(name="Exp_create02",
                                      tags={"version": "v1", "priority": "p1"},
                                      artifact_location=artifacts_loc
                                      )

    exp_details = mlflow.get_experiment(exp_id)

    print("Exp Name : ", exp_details.name)
    print("Exp ID : ", exp_details.experiment_id)
    print("Exp Tags: ", exp_details.tags)
    print("Exp Artifact Location : ", exp_details.artifact_location)
    print("Exp Lifecycle Stage : ", exp_details.lifecycle_stage)
