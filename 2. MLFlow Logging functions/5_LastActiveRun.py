...
if __name__ =="__main__":
    ...
    lastactive_run = mlflow.last_active_run()

    print("From inside the start_run() method")
    print("Last Active Run Name : ", lastactive_run.info.run_name)
    print("Last Active Run Id : ", lastactive_run.info.run_id)
    print()

    mlflow.end_run()
    print("From outside the start_run() method")
    print("Last Active Run Name : ", lastactive_run.info.run_name)
    print("Last Active Run Id : ", lastactive_run.info.run_id)
